...
export default function Home(){
  ...
  return <main>
    ...
    </div><footer className="siteFooter"><span>OncoCohort · Clinical Research Workspace · <a href="/compliance">Compliance & intended use</a></span><span>Data refreshed 14 minutes ago</span></footer>
  </main>
}
